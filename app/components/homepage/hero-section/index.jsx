        ...
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="mb-12 mt-8 flex items-center gap-5">
            ...
            {personalData.leetcode && (
              <Link href={personalData.leetcode} target="_blank" aria-label="LeetCode" className="transition-all text-pink-500 hover:scale-125 duration-300">
                <SiLeetcode size={30} />
              </Link>
            )}
            {personalData.twitter && (
              <Link href={personalData.twitter} target="_blank" aria-label="Twitter" className="transition-all text-pink-500 hover:scale-125 duration-300">
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                {featuredSkills.map((skill, index) => (
                  <span key={skill}>
                    ...
                    {index < featuredSkills.length - 1 && <span className="text-gray-400">, </span>}
                  </span>
                ))}
                <span className="text-gray-400">{"],"}</span>
              </div>
